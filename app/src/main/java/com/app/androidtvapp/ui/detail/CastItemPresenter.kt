...
import com.app.androidtvapp.util.Common
...
//        params.height = Common.getHeightPercent(parent.context, 15)
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, item: Any?) {
        ...
        binding.castImg.load("https://www.themoviedb.org/t/p/w500" + cast.profile_path) {
