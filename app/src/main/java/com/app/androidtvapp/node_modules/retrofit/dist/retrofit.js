...
/***/ function(module, exports, __webpack_require__) {
	...
	var classCallCheck = __webpack_require__(1).default
	var createClass = __webpack_require__(2).default
	var get = __webpack_require__(21).default
	var inherits = __webpack_require__(41).default
	var possibleConstructorReturn = __webpack_require__(90).default
	
	function build(_A, matches) {
	  inherits(B, _A)
	  ...
	  function B() {
	    ...
	    return possibleConstructorReturn(
	      this,
	      Object.getPrototypeOf(B).apply(this, arguments)
	    )
	  }
	
	  var names = methods(Object.getPrototypeOf(B.prototype))
	  var fns = []
	  var fn_cache = {}
	  ...
	  matches.forEach(function(match) {
	    ...
	    if (typeof regex == "string")
	      ...
	      name_matches = names.filter(function(name) {
	        return name.match(regex)
	      })
	    
	    name_matches.forEach(function(name) {
	      var cache = fn_cache[name]
	      var proto = Object.getPrototypeOf(B.prototype)
	      var value
	
	      if (cache == undefined)
	        fn_cache[name] = value = function() {
	          var self = this
	          var args = Array.prototype.slice.call(arguments)
	          var superFn = get(proto, name, self)
	
	          return fn({
	            args: args,
	            fn: superFn ?
	              function() { return superFn.apply(self, args) } :
	              null,
	            instance: self,
	            name: name
	          })
	      ...
	      fns.push({ key: name, value: value })
	    })
	  })
	
	  return createClass(B, fns)
	}
	
	function methods(instance, as_is) {
	  var proto
	
	  if (instance) proto = instance.__proto__
	  if (!proto) return []
	
	  var properties = Object.getOwnPropertyNames(instance)
	    .concat(methods(proto, false))
	
	  return as_is ? properties : uniq(properties)
	}
	...
	function uniq(exts) {
	  ...
	  exts.forEach(function(e) {
	    if (map.hasOwnProperty(e)) return
	    map[e] = null
	    array.push(e)
	  })
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(9)(Function.call, __webpack_require__(39).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
